...
<form id="my-form">
    ...
    <div class="form-group">
        <input type="number" class="form-control form-control-user" id="phone" placeholder="Phone number">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <input type="password" class="form-control form-control-user" id="passr" placeholder="Repeat Password">
            <span role="alert" id="cpassError" class="ml-2 text-danger" aria-hidden="true">
                Please enter Repeat Password
            </span>
        </div>
    </div>
    <button type="button" class="badge badge-primary  m-2" id="btn-show-password"><i
            class="fas fa-check text-light"></i></button>Show Password
</form>
